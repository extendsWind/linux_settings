...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(markdown-mode)
...
;;  (setq x-select-enable-clipboard nil) ;; avoid blocking when quit
  ...
  ;; hang when close the emacs, close clipman solve the problem


  ;; ### python

  ;; #### May be used in selection of python version
