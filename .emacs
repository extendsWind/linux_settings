...
(custom-set-variables
 ...
 '(custom-safe-themes (quote ("b571f92c9bfaf4a28cb64ae4b4cdbda95241cd62cf07d942be44dc8f46c491f4"
			      default))) 
 '(package-selected-packages (quote (elisp-format helm molokai-theme dumb-jump evil
						  auto-complete-c-headers auto-complete python-mode
						  neotree flycheck material-theme better-defaults
						  undo-tree))) 
 '(tool-bar-mode nil))
